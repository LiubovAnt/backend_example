# Generated by Django 3.2 on 2022-02-07 12:20
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('movie', 'movie'), ('TV series', 'TV series')], default='movie', max_length=9)),
            ],
            options={
                'verbose_name': 'movie',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('created', models.DateTimeField(auto_now_add=True)),
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('role', models.CharField(choices=[('director', 'director'), ('writer', 'writer'), ('actor', 'actor')], default='actor', max_length=9)),
